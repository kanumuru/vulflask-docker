...
RUN apt-get update -y \
  && apt install -y aptitude tzdata software-properties-common wget curl httpie git zip unzip python3-pip build-essential libssl-dev libffi-dev python3-dev python3-distutils supervisor python3-setuptools python3-venv
